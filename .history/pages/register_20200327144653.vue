    ...
    <div class="register mt-4 pa-5">
      <ValidationObserver ref="form">
        <form> 
          ...
          <div class="form-group" v-if="model.property.value === 1 || model.property.value === 2 || model.property.value === 3">
            <ValidationProvider
              v-slot="{ errors }"
              name="floors"
              rules="required"
          ...
          <div class="form-group" v-if="model.property.value === 1 || model.property.value === 2">
            <ValidationProvider
              v-slot="{ errors }"
              name="floorNumber"
              rules="required"
          ...
          <template v-if="model.property.value === 4">
            <div class="form-group">
          ...
          <div class="form-group" v-if="model.property.value === 1">
          ...
          <div class="form-group" v-if="model.property.value === 3">
          ...
          <div class="form-group" v-if="model.property.value === 3 || model.property.value === 4">
            <ValidationProvider
              v-slot="{ errors }"
          ...
          <div class="form-group" v-if="model.property.value === 1 || model.property.value === 3">
            <ValidationProvider
              v-slot="{ errors }"
          ...
          <div class="form-group" v-if="model.property.value === 2">
            <ValidationProvider
              v-slot="{ errors }"
              name="Nº de galeria"
              rules="required"
...
export default {
  ...
  async asyncData ({params, store}) {
    if(store.state.registerVisit.isVisitData){
      ...
      console.log(data.data.bikerform);
    }

    dataProperty = await $backend.getPropertyOptions()

    return {propertyItems: dataProperty.data}
  },
  computed: mapState({
