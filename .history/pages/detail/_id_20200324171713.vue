      ...
      <article>
        ...
        >
          ...
          <div class="contact__name">
            ...
            <p class="dni text-truncate">{{contact.type_document.short_name}} {{contact.document}}</p>
          </div>
          <a
...
export default {
  ...
  methods: {
    ...
    async refuse() {
      let motive = '';
      if(this.declineMotive !== 'Otro'){
        motive = this.declineMotive;
      }else{
        motive = this.otherMotive;
      }
