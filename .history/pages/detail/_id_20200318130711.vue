<template>
  <section>
    ...
    <div class="detail-content">
        ...
        <v-card class="detail">
          ...
          <div class="middle d-flex mt-2 pa-4 align-start">
            ...
            <div class="detail__direction">
              <p class="dir">
                Av. Aramburú 279, San Isidro. Lima
              </p>
              <p class="ref">
                Ref. A una cuadra de la Av. Brasil
              </p>
              <div class="dash"></div>
              <p class="description">
                Casa de 2 pisos, fachada blanca con verde (falta construir una
                parte del 2do piso)
              </p>
            </div>
          </div>
      ...
      <article>
        <v-card
          class="contact d-flex justify-space-between align-center pa-4   "
        >
          ...
          <div class="contact__name">
            <p class="name text-truncate">
              Jorge A. Luna Ricardo Mendoza
            </p>
            <p class="dni text-truncate">DNI 45324163</p>
          </div>
          <a
            href="tel:955061182"
...
export default {
  ...
  async asyncData () {
    ...
    data.forEach(element => {
      if(element.state === 'CANCELADO'){canceled.push(element)};
      if(element.state === 'PENDIENTE'){opened.push(element)};
      if(element.state === 'VISITADO'){closed.push(element)};
      });
    

    return {canceled, opened, closed }
  },
  methods: {
    bgclick(){
