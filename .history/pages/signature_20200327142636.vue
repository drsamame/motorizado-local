...
export default {
  ...
  methods: {
    ...
    async uploadImage(image) {
      ...
      await axios.sendSignature({
        method:'put',
        url: 'https://api.dev.prestamype.com/v1/admin/biker/visit/signature/'+this.$store.state.registerVisit.visitId,
        data:{url_image: imageUrl,name_image},
        headers: {
