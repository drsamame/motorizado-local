  ...
  <section>
    <v-row class="px-4 top">
      <div class="content-back d-flex align-center justify-start">
        <nuxt-link :to="'/detail'+$store.state.registerVisit.userId" class="back d-inline-flex align-center"
    ...
    <div class="register mt-4 pa-5">
      <ValidationObserver ref="form">
        <form> 
          ...
          <div class="form-group" v-if="model.property === 1 || model.property === 2 || model.property === 3">
            <ValidationProvider
              v-slot="{ errors }"
              name="floors"
              rules="required"
          ...
          <div class="form-group" v-if="model.property === 1 || model.property === 2">
            <ValidationProvider
              v-slot="{ errors }"
              name="floorNumber"
              rules="required"
          ...
          <template v-if="model.property === 4">
            <div class="form-group">
          ...
          <div class="form-group" v-if="model.property === 1">
          ...
          <div class="form-group" v-if="model.property === 3">
          ...
          <div class="form-group" v-if="model.property === 3 || model.property === 4">
            <ValidationProvider
              v-slot="{ errors }"
          ...
          <div class="form-group" v-if="model.property === 1 || model.property === 3">
            <ValidationProvider
              v-slot="{ errors }"
              name="metraje techado"
              rules="required|max_value:2000"
            >
              <v-text-field
          ...
          <div class="form-group" v-if="model.property === 2">
            <ValidationProvider
              v-slot="{ errors }"
              name="Nº de galeria"
              rules="required"
...
export default {
  ...
  methods: {
    ...mapActions({
      setVisitData: 'registerVisit/savePhoto',
  ...
  mounted() {
    console.log(this.$store.state.registerVisit.userId);
  }
}
</script>
